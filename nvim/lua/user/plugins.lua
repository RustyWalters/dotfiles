...
return packer.startup(function(use)
  ...
  --  original working, commented out the following 3 on 01.10.2025, trying most recent with no commit number
  ...
  use { "nvimtools/none-ls.nvim", commit = "7e146f3a188853843bb4ca1bff24c912bb9b7177" } -- for formatters and linters
  ...
  -- debug support for node/jest tests
